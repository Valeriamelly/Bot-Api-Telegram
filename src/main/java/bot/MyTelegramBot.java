...
public class MyTelegramBot extends TelegramLongPollingBot {
    ...
    private ReporteDataAccess reporteDataAccess;

    public MyTelegramBot() {
        try {
            this.reporteDataAccess = new ReporteDataAccess(
                    SheetsServiceUtil.getSheetsService(), // Inicializa el servicio de Sheets
                    "INGRESE SU ID" // Usa el ID de tu hoja de cálculo

            );
            this.reporte = reporteDataAccess.obtenerReportesDesdeRango("Sheet1!A1:J25"); // Asegúrate de especificar el rango correcto
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public String getBotToken() {
        ...
        return "INGRESE SU ID DE TELEGRAM";
    }
        ...
        for (Reporte x : reporte) {
            if (x.getId().equals(id)) {
                ...
                String respuesta = "<b>Reporte Encontrado:</b>\n"
                        ...
                        + "<b>Componente:</b> " + x.getComponente() + "\n"
